...
const FEATURES: FeatureStatus[] = [
  ...
  },
  {
    ...
    status: "beta",
    note: "MIDI 가져오기, 피아노롤에서 음표·코드·구간 드래그(이동/크기조절)·추가·삭제, 표 편집, 스타일별 생성, 구간별 재생성, MIDI·JSON 내보내기, 자동 저장을 지원합니다.",
  },
  {
    name: "프로젝트 저장",
    status: "beta",
    note: "브라우저 IndexedDB에 자동 저장되어 새로고침 후에도 복구됩니다. \"최근 프로젝트\" 목록에서 여러 프로젝트를 열고 삭제할 수 있습니다.",
  },
  {
    name: "가이드 재생",
    status: "beta",
  ...
  },
  {
    name: "녹음",
    status: "beta",
    note: "마이크로 녹음하고 바로 들어본 뒤 파일로 내보낼 수 있습니다. \"재생하며 녹음\" 버튼으로 가이드 재생과 함께 시작할 수도 있습니다 (표본 단위로 정확히 맞춘 동기화는 아닙니다).",
  },
  {
    name: "음원 업로드·자동 분석",
